...
b.addEventListener("keydown", function (e) {
	if (e.keyCode == 115) {
		if (document.getElementById('pageinfo').style.display === "none") {document.getElementById('pageinfo').style.display = 'block';} else {document.getElementById('pageinfo').style.display = 'none';};
	} 
});
