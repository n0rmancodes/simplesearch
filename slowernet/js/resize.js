...
window.onresize = function(event) {
	...
	if (w < 1138) {document.getElementById("title").style = "font-size:65px"; document.getElementById("welcome").style = "font-size:20px;"; document.getElementById("header").style = "width:45%; background-color:black; height: 15%;";}
	...
	if (w < 759) {document.getElementById("title").style = "font-size:60px;"; document.getElementById("welcome").style = "font-size:20px;"; document.getElementById("header").style = "width:65%; background-color:black; height: 15%;";}
	...
	if (w < 536) {document.getElementById("title").style = "font-size:60px;"; document.getElementById("welcome").style = "font-size:20px;"; document.getElementById("header").style = "width:90%; background-color:black; height: 15%;";}
	if (w < 401) {document.getElementById("title").style = "font-size:52px;"; document.getElementById("welcome").style = "font-size:20px;"; document.getElementById("header").style = "width:99%; background-color:black; height: 15%;";}
	if (w < 320) {document.getElementById("title").style = "font-size:48px;"; document.getElementById("welcome").style = "font-size:20px;"; document.getElementById("header").style = "width:99%; background-color:black; height: 15%;";}
};
function getSize() {
	var w = window.innerWidth;
	var h = window.innerHeight;
	...
	if (w < 700) {document.getElementById("title").style = "font-size:55px;"; document.getElementById("welcome").style = "font-size:20px;"; document.getElementById("header").style = "width:70%; background-color:black; height: 15%;";}
	if (w < 650) {document.getElementById("title").style = "font-size:60px;"; document.getElementById("welcome").style = "font-size:20px;"; document.getElementById("header").style = "width:85%; background-color:black; height: 15%;";}
	if (w < 536) {document.getElementById("title").style = "font-size:60px;"; document.getElementById("welcome").style = "font-size:20px;"; document.getElementById("header").style = "width:99%; background-color:black; height: 15%;";}
	if (w < 372) {document.getElementById("title").style = "font-size:52px;"; document.getElementById("welcome").style = "font-size:20px;"; document.getElementById("header").style = "width:99%; background-color:black; height: 15%;";}
	if (w < 320) {document.getElementById("title").style = "font-size:48px;"; document.getElementById("welcome").style = "font-size:20px;"; document.getElementById("header").style = "width:99%; background-color:black; height: 15%;";}
}