...
function getBackground() {
	...
	if (curBack === "img/41.jpg") {var credit = "Elena Prokofyeva on Unsplash"}
	if (curBack === "img/42.jpg") {var credit = "ian dooley on Unsplash"}
	if (curBack === "img/43.jpg") {var credit = "Free-Photos from Pixabay"}
	if (curBack === "img/44.jpg") {var credit = "Felix Mittermeier from Pixabay"}
	if (curBack === "img/45.jpg") {var credit = "sutulo from Pixabay"}
	if (curBack === "img/46.jpg") {var credit = "Pexels from Pixabay"}
	if (curBack === "img/47.jpg") {var credit = "Arek Socha from Pixabay"}
	if (curBack === "img/48.jpg") {var credit = "David Mark from Pixabay"}
	if (curBack === "img/49.jpg") {var credit = "David Mark from Pixabay"}
	if (curBack === "img/50.jpg") {var credit = "David Mark from Pixabay"}
	if (curBack === "img/51.jpg") {var credit = "Couleur from Pixabay"}
	document.getElementById("pC").innerHTML = credit;
}

function linkMode() {
	if (document.getElementById("search").placeholder === "search now") {toggleLMon(); document.getElementById("searchBtn").innerHTML = "link"} else {toggleLMoff(); document.getElementById("searchBtn").innerHTML = "search"}
}
